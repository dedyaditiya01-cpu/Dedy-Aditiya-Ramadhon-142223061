...
menu = st.sidebar.selectbox(
    "Menu",
    ["Dashboard","Data Responden"]
)

if menu == "Dashboard":
    c1,c2,c3 = st.columns(3)
    c1.metric("Total Responden", len(df))
    c2.metric("Mahasiswa", (df["Status Anda saat ini"]=="Mahasiswa").sum())
    c3.metric("Pekerja", (df["Status Anda saat ini"]=="Pekerja").sum())

    st.subheader("Jenis Kelamin")
    st.bar_chart(df["  Jenis kelamin  "].value_counts())

    st.subheader("Status")
    st.bar_chart(df["Status Anda saat ini"].value_counts())
